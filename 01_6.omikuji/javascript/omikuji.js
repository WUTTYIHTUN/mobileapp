...
window.addEventListener("DOMContentLoaded",
    function () {
        ...
        this.setTimeout(
            function () {
                let popMessage = "いらっしゃい!おみくじ引くてって!";
...
let soundEndflag = "0";/*sound control,omikuji picture and text*/
...
btn1.addEventListener("click",
    function () {
        if (soundEndflag == "1") {
            soundControl("end", "");/*sound control*/
        }
        ...
        let resultMaxSpeed = [10, 10, 8, 5, 5];//if number Index
